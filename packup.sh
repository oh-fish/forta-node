...
#  sleep 1
#done
FORTA_CORE_GO_VERSION=github.com/forta-network/forta-core-go@v0.0.0-20240306085049-a1ac54ae90f5
ONEFISH_FORTA_CORE_GO_VERSION=github.com/oh-fish/forta-core-go@v0.1.1
